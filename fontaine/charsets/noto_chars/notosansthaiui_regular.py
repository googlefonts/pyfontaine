...
class Charset(object):
    common_name = 'NotoSansThaiUI-Regular'
    native_name = ''
    ...
    def glyphs(self):
        ...
        chars.append(0x0E48)  #uni0E48	THAI CHARACTER MAI EK
        chars.append(0x0E49)  #uni0E49	THAI CHARACTER MAI THO
        chars.append(0x0E4A)  #uni0E4A	THAI CHARACTER MAI TRI
        chars.append(0x0E4B)  #uni0E4B	THAI CHARACTER MAI CHATTAWA
        chars.append(0x0E4C)  #uni0E4C	THAI CHARACTER THANTHAKHAT
