...
Fixed width: no
Fixed sizes: no
Copyright: Copyright 1991 as an unpublished work by Bitstream Inc.
    All rights reserved.  Confidential.
License: Bitstream Vera License (and derivative projects)
License url: http://www.gnome.org/fonts/
Version: Version 2.0; 1991
Vendor:
Vendor url:
Designer:
Designer url:
